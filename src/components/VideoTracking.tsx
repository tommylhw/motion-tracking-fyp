...
// // Define the type for a single keypoint (same as in ThinkingAnimation.tsx)
// type KEYPOINT_TYPE = {
//   frame_id: number;
//   kpt_id: number;
//   normalzed_coords: number[]; // Note: "normalzed" seems to be a typo; should be "normalized"
//   coords: number[];
// };

// // Define the main type for video detected keypoints (same as in ThinkingAnimation.tsx)
...
//   const [detectedKeypoints, setDetectedKeypoints] = useState<VIDEO_DETECTED_KEYPOINTS_TYPE[]>([]);
...
//       const frame_id = 0; // Initialize frame_id
...
//       <div>
//         {
//           JSON.stringify(detectedKeypoints, null, 2).split("\n").map((line, index) => (
