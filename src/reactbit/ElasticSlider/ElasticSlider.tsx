...
const Slider: React.FC<SliderProps> = ({
  ...
  useEffect(() => {
    if (onValueChange) {
      onValueChange(value); // Call the function passed from the parent
    }
  }, [value, onValueChange]);
  ...
  return (
    <div className="w-full flex gap-4 items-center justify-center ">
      ...
      >
        ...
        <div
          ref={sliderRef}
          className="relative flex w-full max-w-xs cursor-grab touch-none select-none items-center py-4"
      ...
      <p className="w-[30%] text-custom-on-surface-container transform text-xs font-medium tracking-wide">
        {Math.round(value)} %
      </p>
    </div>
  );
